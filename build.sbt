...
lazy val core = (project in file("core"))
  ...
  .settings (
    ...
    dependencyOverrides += "org.apache.arrow" % "arrow-vector" % "14.0.2",
    dependencyOverrides += "org.apache.arrow" % "arrow-memory-unsafe" % "14.0.2",
    dependencyOverrides += "org.apache.arrow" % "arrow-memory-netty" % "14.0.2",
    dependencyOverrides += "org.apache.arrow" % "arrow-memory-core" % "14.0.2",
    dependencyOverrides += "org.apache.arrow" % "arrow-format" % "14.0.2",
    dependencyOverrides += "org.apache.arrow" % "arrow-c-data" % "14.0.2",
